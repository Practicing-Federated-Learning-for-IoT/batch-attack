...
def args_parser():
    ...
    parser.add_argument('--iid', type=int, default=1,  help='whether i.i.d or not')#action='store_true',
    ...
    parser.add_argument('--atk', type=str, default='lowhigh')
    parser.add_argument('--attack_type', type=str, default='reorder')
    parser.add_argument('--atk_num', type=int, default=20)
